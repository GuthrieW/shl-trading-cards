...
import { UseGetApprovedCardsKey } from '@pages/_old/api/queries/use-get-approved-cards'
import { UseGetUnapprovedCardsKey } from '@pages/_old/api/queries/use-get-unapproved-cards'
import { UseGetRequestedCardsKey } from '@pages/_old/api/queries/use-get-requested-cards'
import { UseGetAllCardsKey } from '@pages/_old/api/queries/use-get-all-cards'
